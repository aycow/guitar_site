      ...
      <div className="relative z-10 p-6 md:p-8 max-w-7xl mx-auto">
        ...
        <div className="mb-8 bg-gray-900 border border-gray-700 rounded-xl p-6 shadow-lg">
          ...
          {(selectedMode || selectedCategory) && (
            <div className="mt-4 flex flex-wrap items-center gap-3">
              ...
              {selectedMode && (
                <div className="flex items-center gap-2 bg-gray-800 text-gray-200 px-3 py-1 rounded-full text-sm border border-gray-700">
        ...
        {filteredLevels.length > 0 ? (
          ...
          <div className="text-center py-12">
            <div className="inline-block bg-gray-900 border border-gray-700 rounded-lg p-8">
